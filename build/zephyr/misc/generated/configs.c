...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_PARTICLE_GEN3_HEADER_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SKYWORKS_SKY13351_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PARTICLE_XENON, 1);
